...
// === ЛОГ ЗАПУСКА ===
console.log("🚀 Server restarting... Loomy AI 3.0 (Profile & Stars)");
...
bot.on('successful_payment', async (ctx) => {
    ...
    // Определяем сколько месяцев добавить
    let monthsToAdd = 1;
    ...
    // Если подписка уже есть, продлеваем её, иначе ставим от сегодня
